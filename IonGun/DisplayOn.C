...
// the iongun.mac contains the necessary commands to
// start up the visualization, the next event will
// be displayed. Execute this macro after you run
// Fun4All_G4_IonGun.C(0), then do
// PHG4Reco *g4 = DisplayOn();
PHG4Reco * DisplayOn(const char *mac = "iongun.mac")
{
  char cmd[100];
