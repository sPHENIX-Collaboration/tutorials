 ...
 */
JetFinder::JetFinder(const std::string &name, const std::string &filename)
  : SubsysReco(name)
 ...
 */
int JetFinder::Init(PHCompositeNode *topNode)
{
  if (Verbosity() > 5)
  {
    cout << "Beginning Init in JetFinder" << endl;
  }
 ...
 */
int JetFinder::process_event(PHCompositeNode *topNode)
{
  if (Verbosity() > 5)
  {
    cout << "Beginning process_event in JetFinder" << endl;
  }
 ...
 * loose ends
 */
int JetFinder::End(PHCompositeNode *topNode)
{
  if (Verbosity() > 1)
  {
    cout << "Ending JetFinder analysis package" << endl;
  }
  ...
  if (Verbosity() > 1)
  {
    cout << "Finished JetFinder analysis package" << endl;
  }
 ...
 */
void JetFinder::getHEPMCTruth(PHCompositeNode *topNode)
{
 ...
 * partons here.
 */
void JetFinder::getPHG4Truth(PHCompositeNode *topNode)
{
 ...
 * by the 
 */
void JetFinder::getTracks(PHCompositeNode *topNode)
{
  /// SVTX tracks node
 ...
 */
void JetFinder::getTruthJets(PHCompositeNode *topNode)
{
  if (Verbosity() > 1)
  {
 ...
 */
void JetFinder::getReconstructedJets(PHCompositeNode *topNode)
{
 ...
 * the IHCal, etc.)
 */
void JetFinder::getEMCalClusters(PHCompositeNode *topNode)
{
  ...
  if (!vertexmap)
  {
    cout << "JetFinder::getEmcalClusters - Fatal Error - GlobalVertexMap node is missing. Please turn on the do_global flag in the main macro in order to reconstruct the global vertex." << endl;
  ...
  if (vertexmap->empty())
  {
    cout << "JetFinder::getEmcalClusters - Fatal Error - GlobalVertexMap node is empty. Please turn on the do_global flag in the main macro in order to reconstruct the global vertex." << endl;
    return;
  }
 ...
 * clutter up the JetFinder::Init function.
 */
void JetFinder::initializeTrees()
{
 ...
 * trees. 
 */
void JetFinder::initializeVariables()
{
  m_outfile = new TFile();
  m_phi_h = new TH1F();
