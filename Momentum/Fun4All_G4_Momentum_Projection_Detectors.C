#ifndef FUN4ALL_G4_MOMENTUM_PROJECTION_DETECTORS_C
#define FUN4ALL_G4_MOMENTUM_PROJECTION_DETECTORS_C
...
int Fun4All_G4_Momentum_Projection_Detectors(const int nEvents = 1000, const string &evalfile = "FastTrackingEval.root", const string &outfile = "")
{
  ///////////////////////////////////////////
  // Make the Server
  //////////////////////////////////////////
  ...
  Fun4AllInputManager *in = new Fun4AllDummyInputManager("ZEN");
