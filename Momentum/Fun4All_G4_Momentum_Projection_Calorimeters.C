...
int Fun4All_G4_Momentum_Projection_Calorimeters(const int nEvents = 1000, const string &evalfile = "FastTrackingEval.root", const string &outfile = "")
{
  ///////////////////////////////////////////
  // Make the Server
  //////////////////////////////////////////
  ...
  Fun4AllInputManager *in = new Fun4AllDummyInputManager("ANA");
